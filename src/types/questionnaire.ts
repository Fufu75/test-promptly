...
export const INITIAL_QUESTIONNAIRE: QuestionnaireQuestion[] = [
  {
    ...
    description: 'Décrivez votre activité (ex: Salon de coiffure, Cabinet médical, Terrain de padel…)',
    required: true,
  ...
  },
  {
    ...
    description: "Listez vos jours d'ouverture (ex: Du lundi au vendredi, ou Lundi, Mercredi, Samedi)",
    required: true,
    placeholder: 'Ex: Du lundi au samedi',
  },
  {
    id: 'opening_hours',
    type: 'text',
  ...
  },
  {
    id: 'ambiance',
    type: 'text',
    label: "En 3 mots, décrivez l'ambiance de votre site",
    description: "Ces mots orientent le style visuel choisi par l'IA. Ex: moderne épuré chaleureux — luxe élégant sobre — dynamique sport énergique",
    required: false,
    placeholder: 'Ex: moderne, épuré, chaleureux',
  },
  {
    id: 'primary_color',
    type: 'color',
    label: 'Quelle couleur principale souhaitez-vous ?',
